	...
	/*  */
	{
		...
		//if($form->isValid()) {
			...
			if ($connect) {
				...
				echo 'Le nombre d\'entrées est '.ldap_count_entries($connect,$search).'<br/>';
				...
				for ($i=0 ; $i<$info["count"] ; $i++){
					...
					for ($j = 0; $j < $nb_membres-1 ; $j++){
						...
						echo 'Le nombre d\'entrées est '.ldap_count_entries($connect,$search_membres).'<br/>';
					...
					//$base_dn_members = $member."";
						...
						//echo 'Le nombre d\'entrées est '.ldap_count_entries($connect,$search_members).'<br/>';
