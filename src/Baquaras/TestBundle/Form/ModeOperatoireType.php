...
class ModeOperatoireType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
			...
			->add('prerequis', 'textarea', array(
				'label' => 'Pré-requis connexions et services',
				'attr' => array('class' => 'ckeditor')))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Baquaras\TestBundle\Entity\ModeOperatoire'
        ));
    }
    ...
    {
        return 'baquaras_testbundle_modeoperatoire';
    }
}
